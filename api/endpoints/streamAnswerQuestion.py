...
@router.get('/streamAnswerQuestion', response_class = StreamingResponse)
def streamAnswerQuestion(endpoint_request: streamAnswerQuestionRequest = Depends(), auth: str = Depends(authenticate)):
    """
