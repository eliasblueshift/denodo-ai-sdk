...
@router.get('/answerDataQuestion', response_class = JSONResponse, response_model = answerDataQuestionResponse, tags = ['Ask a Question'])
def answer_data_question_get(
    ...
    return process_data_question(request, auth)

@router.post('/answerDataQuestion', response_class = JSONResponse, response_model = answerDataQuestionResponse, tags = ['Ask a Question'])
def answer_data_question_post(
    ...
    As you can see, you can specify a different provider for SQL generation and chat generation. This is because generating a correct SQL query
    is a complex task that should be handled with a powerful LLM.'''
    return process_data_question(endpoint_request, auth)

def process_data_question(request_data: answerDataQuestionRequest, auth: str):
