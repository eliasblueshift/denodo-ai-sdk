...
@router.get('/answerDataQuestion', response_class = JSONResponse, response_model = answerDataQuestionResponse)
def answerDataQuestion(endpoint_request: answerDataQuestionRequest = Depends(), auth: str = Depends(authenticate)):
    """
